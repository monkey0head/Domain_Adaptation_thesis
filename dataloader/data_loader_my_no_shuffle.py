...
def create_data_generators_my(dataset_name, domain, data_path="data", batch_size=16,
...
def create_dataset(dataset_name, domain, data_path, split_ratios, transform, image_size, device):
    ...
    if dataset_name == "office-31":
        ...
        dataset = Office31Dataset(f"{data_path}/{dataset_name}/{domain}/images", transform=transform,
